...
\subsubsection{Λειτουργία Reset και Read/Write}
...
\begin{lstlisting} [caption=Always block του Registel file, language=Verilog]
always @(posedge clk or negedge resetn) begin
    if (!resetn) begin
        ...
        if (write) begin
            ...
            readData1 <= registers[readReg1]; // Read
            ...
        end
    end
\end{lstlisting}
...
\textbf{Σημείωση:} Λόγω της σύγχρονης ανάγνωσης (τα δεδομένα εμφανίζονται στον επόμενο κύκλο), το FSM που θα χρησιμοποιήσει αυτό το Register File πρέπει να εφαρμόσει τεχνική \textbf{pre-fetching διευθύνσεων} (βλ. Άσκηση 4).
\newpage